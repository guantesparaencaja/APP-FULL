      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex justify-between items-center mb-8 px-4">
          <button
            ...
            className="btn-press p-3 bg-slate-800 rounded-full text-slate-400 hover:text-white transition-colors"
          >
          ...
          <button aria-label="Ajustes"
            ...
            className={`btn-press p-3 rounded-full transition-colors ${showConfig ? 'bg-primary text-white' : 'bg-slate-800 text-slate-400 hover:text-white'}`}
          >
          ...
          <div className="flex flex-col items-center mt-4">
            <AnimatePresence mode="popLayout">
              <motion.h2
                ...
                transition={spring}
                className={`text-2xl font-black uppercase tracking-[0.2em] ${getPhaseColor()}`}
              >
                {phase === 'IDLE'
                  ? 'LISTO'
                  : phase === 'PREPARE'
        ...
        <div className="flex justify-center gap-6 mb-12">
          <button
            onClick={toggleTimer}
            className={`btn-press w-28 h-28 rounded-full flex items-center justify-center shadow-2xl transition-all ${
          ...
          {phase !== 'IDLE' && (
            <button aria-label="Actualizar"
              ...
              className="btn-press w-28 h-28 rounded-full bg-slate-800 flex items-center justify-center shadow-xl hover:bg-slate-700 transition-all text-slate-300"
            >
                ...
                <motion.div variants={staggerItem} className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-4">
                    <button aria-label="Quitar"
                      ...
                      className="btn-press p-2 bg-slate-800 rounded-lg text-white hover:bg-slate-700"
                    >
