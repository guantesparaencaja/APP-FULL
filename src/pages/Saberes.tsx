...
export function Saberes() {
  ...
  const seedInitialCombos = async () => {
    ...
    const initialCombos = [
      // Nivel 1: Humano (Basicos - 5 golpes + 1 defensa)
      { name: '1-2-3-4-Cintura-2', level: 1 },
      { name: '1-2-3-2-PA-2', level: 1 },
      { name: 'DJ-3-2-Cintura-2', level: 1 },
      // Nivel 2: Discipulo de Roshi (Coordinacion)
      { name: '1-2-3-4-5-Cintura', level: 2 },
      { name: '1-2-3-4-PA-1-2', level: 2 },
      { name: '5-6-3-4-3-Cintura', level: 2 },
      // Nivel 3: Guerrero Z (Defensa)
      { name: '1-2-Cintura-3-2-PA-2', level: 3 },
      { name: 'DJ-Slip-3-2-Cintura-2', level: 3 },
      { name: '1-2-Slip-3-4-Cintura-2', level: 3 },
      // Nivel 4: Sayayin de Elite (Contra-ataque)
      { name: '1-2-3-PA-1-2-Cintura', level: 4 },
      { name: 'DJ-Cabeceo-3-2-Cintura-2', level: 4 },
      { name: '5-6-3-4-Cintura-2', level: 4 },
      // Nivel 5: Super Sayayin (Fluidez)
      { name: '7-8-9-10', level: 5 },
      { name: '1-2-PA-1-2-Cabeceo', level: 5 },
      { name: 'DUP-P', level: 5 },
      // Nivel 6: SSJ 2 (Presion)
      { name: '1-2-3-4-5-6-7-8', level: 6 },
      { name: 'DJ-Recto-PA-DUP-P', level: 6 },
      { name: 'Gancho-Recto Cuerpo-118-112', level: 6 },
      // Nivel 7: SSJ 3 (Angulos - Lomachenko)
      { name: '1-2-Pivote-3', level: 7 },
      { name: '1-2-Gancho Cuerpo-Gancho Cabeza', level: 7 },
      { name: '1-2-Cintura-3-2', level: 7 },
      { name: 'DJ-Pivote-3-2', level: 7 },
      { name: '1-2-Slip-3-2', level: 7 },
      // Nivel 8: SSJ Dios (Velocidad - Naoya Inoue)
      { name: '1-1-2-3-2', level: 8 },
      { name: '1-2-Gancho Cuerpo-2-Gancho Cabeza', level: 8 },
      { name: '1-2-5-6-3', level: 8 },
      { name: 'DJ-Recto-Gancho Cuerpo-2', level: 8 },
      { name: '1-2-3-2-Gancho Cuerpo-2', level: 8 },
      // Nivel 9: SSJ Blue (Maestria Cuerpo)
      { name: '1-2-Gancho Cuerpo-5-2', level: 9 },
      { name: '1-Recto Cuerpo-Gancho Cabeza-6-Gancho Cabeza', level: 9 },
      { name: 'DJ-Gancho Cuerpo-2-5-Gancho Cabeza', level: 9 },
      { name: '1-2-Gancho Cuerpo-Gancho Cabeza-2-5', level: 9 },
      { name: '1-Uppercut Cuerpo-Gancho Cabeza-2-Gancho Cuerpo-5', level: 9 },
      // Nivel 10: Ultra Instinto S (Contraataque - Mayweather)
      { name: '1-2-Slip-2-3', level: 10 },
      { name: '1-2-Cintura-5-Gancho Cabeza-2', level: 10 },
      { name: '1-Feint-3-2-Pull-2', level: 10 },
      { name: '1-2-Pull-2-Gancho Cuerpo', level: 10 },
      { name: '1-2-Slip-Gancho Cuerpo-Uppercut Cabeza-2', level: 10 },
      // Nivel 11: Ultra Instinto D (Perfeccion)
      { name: '1-2-Slip-2-Cintura-3-2', level: 11 },
      { name: 'DJ-2-Slip-Cintura-5-3-2', level: 11 },
      { name: '1-2-Gancho Cuerpo-Gancho Cabeza-Cintura-2-5', level: 11 },
      { name: '1-2-Pull-2-Slip-5-Gancho Cabeza-2', level: 11 },
      { name: '1-Feint-Gancho Cuerpo-2-Slip-5-Gancho Cabeza-2', level: 11 },
      // Nivel 12: Dios de la Destruccion
      { name: '1-1-2-3-2-Slip-Cintura-5-Gancho Cabeza-2', level: 12 },
      { name: '1-2-3-2-5-6-Gancho Cuerpo-Gancho Cabeza-2-Cintura-3-2', level: 12 },
      { name: '1-2-Gancho Cuerpo-Gancho Cabeza-2-5-6-3', level: 12 },
      { name: '1-2-Slip-Cintura-Pull-2-5-3-Uppercut Cabeza-2', level: 12 },
      { name: '1-Feint-2-Slip-Gancho Cuerpo-5-Gancho Cabeza-Cintura-Uppercut Cabeza-2-Pull-3-2', level: 12 },
      { name: 'DJ-2-Pivote-Gancho Cuerpo-Gancho Cabeza-2-Cintura-5', level: 12 },
      { name: 'DJ-Recto-Gancho Cuerpo-5-Gancho Cabeza-Cintura-2-Uppercut Cabeza-3-2', level: 12 },
    ];
