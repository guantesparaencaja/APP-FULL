...
export const Calentamiento: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans p-4 pb-24">
      <div className="max-w-4xl mx-auto w-full pt-4 mb-8">
        <PageHeader
          emoji="🔥"
          title="Calentamiento"
          subtitle="Guantes Protocolo"
          right={
            <button aria-label="Volver"
              onClick={() => navigate(-1)}
              className="btn-press w-12 h-12 flex items-center justify-center bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 transition-transform active:scale-90"
            >
        ...
        <section className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 overflow-hidden shadow-2xl relative">
          {loadingVideo ? (
            ...
            <motion.div
              ...
              initial="hidden"
              animate="show"
              className="aspect-video bg-slate-950 flex flex-col items-center justify-center text-center p-8"
            >
          ...
          <div className="p-8">
            ...
            <motion.button
              ...
              className="btn-press w-full bg-primary py-5 rounded-3xl text-white font-black uppercase italic tracking-widest shadow-xl shadow-primary/30 hover:bg-primary/90 transition-all flex items-center justify-center gap-3"
            >
