...
import { liftCard } from '../lib/animations';
      ...
      <div className="min-h-screen bg-background-light dark:bg-background-dark px-6 py-8">
        <div className="max-w-5xl mx-auto space-y-12">
          <div className="space-y-4">
            <div className="skeleton h-28 w-3/4 max-w-md" />
          ...
          {currentStep === 2 && selectedPlan && (
            ...
            >
              ...
              <motion.button
                ...
                className={`w-full py-6 rounded-[2rem] text-[12px] font-black uppercase tracking-[0.3em] transition-all shadow-xl btn-press ${
                  selectedClasses.length === allowedClasses
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <motion.button
                    ...
                    className={`w-full py-6 rounded-[2rem] flex items-center justify-center gap-3 text-[12px] font-black uppercase tracking-[0.3em] transition-all shadow-xl btn-press ${
                  ...
                  <div className="mt-6 text-center">
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 px-6 py-4 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-emerald-500 hover:text-white transition-all disabled:opacity-50 btn-press"
                    >
          ...
          {currentStep === 4 && (
            ...
            >
              ...
              <button
                ...
                className="w-full py-4 rounded-xl border border-amber-500/50 text-amber-500 uppercase font-black text-xs tracking-widest hover:bg-amber-500 hover:text-white transition-all btn-press"
              >
...
<h2 className="text-5xl font-black uppercase italic tracking-tighter text-white mb-4">
              ...
              <p className="text-emerald-400 font-bold tracking-widest mb-12">
                ¡Gracias por tu compra! Ya formaste parte de la comunidad GPTE.
              </p>
