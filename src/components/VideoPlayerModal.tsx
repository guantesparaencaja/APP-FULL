          ...
          <div className="bg-black/90 px-4 pt-2 pb-1 shrink-0">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <button type="button" onClick={togglePlay} className="text-white p-1.5 rounded-full hover:bg-white/10">
                  {playing ? <Pause className="w-4 h-4" /> : <Play className="w-4 h-4 fill-white" />}
                </button>
                <button type="button" onClick={toggleMute} className="text-white p-1.5 rounded-full hover:bg-white/10">
                  {muted ? <VolumeX className="w-4 h-4" /> : <Volume2 className="w-4 h-4" />}
                </button>
                <span className="text-[10px] text-slate-400 font-bold">{currentTime} / {totalTime}</span>
              </div>
              <div className="flex items-center gap-2">
                <button type="button" onClick={retry} className="text-white p-1.5 rounded-full hover:bg-white/10">
                  <RotateCcw className="w-4 h-4" />
                </button>
                <button type="button" onClick={goFullscreen} className="text-white p-1.5 rounded-full hover:bg-white/10">
