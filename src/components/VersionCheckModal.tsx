...
export function VersionCheckModal({ isOpen, onClose, newVersion, downloadUrl }: VersionCheckModalProps) {
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/80 p-4 backdrop-blur-md">
        ...
        >
          ...
          <h3 className="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tight leading-none mb-2">Nueva Versión</h3>
          <p className="text-sm text-slate-500 font-bold mb-6 uppercase tracking-widest">Versión {newVersion} disponible</p>
          
          <p className="text-slate-600 dark:text-slate-300 mb-8 leading-relaxed">
            Hay una actualización disponible con mejoras y nuevas funciones. ¡Descárgala ahora para mantener tu app al día!
          </p>
