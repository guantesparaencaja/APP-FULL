    ...
    >
      <div className="relative aspect-[4/5] overflow-hidden">
        <img
          src={
            recipe.imagen_url ||
            'https://images.unsplash.com/photo-1495195134817-a1a280719e38?w=800&q=80'
          }
          alt={recipe.titulo}
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4">
          <h3 className="font-bold text-xl text-white mb-2 leading-tight group-hover:text-emerald-400 transition-colors">
            {recipe.titulo}
          </h3>
