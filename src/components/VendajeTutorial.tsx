                  ...
                  {selectedFile && uploadProgress === null && (
                    <div className="bg-slate-950/50 p-4 rounded-xl border border-slate-800 flex flex-col gap-3 my-2">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button aria-label="Subir" type="button" onClick={handleConfirmUpload} className="flex-1 py-2 rounded-lg bg-primary text-black text-xs font-black uppercase hover:bg-primary/90 flex justify-center items-center gap-1"><Upload className="w-3 h-3"/> Confirmar y Subir</button>
                      </div>
                    </div>
                  )}
