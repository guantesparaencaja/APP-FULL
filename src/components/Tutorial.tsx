...
const TUTORIAL_STEPS = [
  {
    ...
    icon: BookOpen,
    description: 'Descubre la teoría, técnica perfeccionada y táctica. El conocimiento de un campeón directo a tu bolsillo.',
    color: 'text-blue-500',
    bg: 'bg-blue-500/20',
  ...
  },
  {
    ...
    icon: Clock,
    description: 'Usa el nuevo Temporizador para tus rounds y nuestras rutinas guiadas. En casa o en el gym, tú decides.',
  ...
  },
  {
    ...
    icon: Calendar,
    description: 'Agenda fácilmente tus sesiones presenciales, selecciona tu horario ideal y asegura tu cupo en tiempo real.',
    ...
    <div className="fixed inset-0 bg-slate-950/95 backdrop-blur-xl z-[100] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <button onClick={handleComplete} className="text-[10px] font-black uppercase tracking-widest text-slate-500 hover:text-white transition-colors">
            Saltar
          </button>
        </div>
        ...
        <div className="min-h-[280px] flex flex-col items-center justify-center text-center relative">
          <AnimatePresence mode="wait">
            ...
            >
              <div className={`w-32 h-32 rounded-3xl ${currentStep.bg} border ${currentStep.border} flex items-center justify-center mb-8 shadow-[0_0_40px_rgba(0,0,0,0.5)] ${currentStep.shadow}`}>
