    ...
    <div className="fixed inset-0 bg-slate-900 z-50 flex flex-col font-display text-white">
      ...
      <div className="p-4 flex justify-between items-center bg-slate-900/80 backdrop-blur-md border-b border-slate-800">
        <div>
          ...
          <p className="text-xs text-slate-400">
            Nivel {level} • Paso {currentStepIndex + 1} de {steps.length}
          </p>
        </div>
      ...
      <div className="flex-1 overflow-y-auto flex flex-col p-6">
        <div className="mb-6">
          ...
          <p className="text-2xl font-black text-white mb-6 bg-slate-800/50 p-6 rounded-2xl border border-slate-700 shadow-inner leading-relaxed">
        ...
        {currentStep.type === 'practice' && (
          <div className="flex-1 flex flex-col items-center justify-center py-8">
            <div
              className={`w-48 h-48 rounded-full flex items-center justify-center border-4 shadow-[0_0_40px_rgba(0,119,255,0.2)] transition-colors duration-500 ${
            ...
            <div className="bg-slate-800 p-6 rounded-2xl border border-slate-700">
              ...
              <div className="space-y-3">
                {currentStep.quiz.options.map((option, idx) => {
                  ...
                  let btnClass =
                    'w-full text-left p-4 rounded-xl border font-medium transition-all ';
        ...
        <div className="mt-auto pt-6">
          <button
            onClick={handleNext}
            disabled={
              (currentStep.type === 'practice' && timeLeft > 0) ||
              (currentStep.type === 'quiz' && quizResult !== 'correct')
            }
